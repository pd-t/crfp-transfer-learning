...
echo "[s3raw]" >> $CREDENTIAL_FILE
echo "aws_access_key_id=$RAW_S3_AWS_ACCESS_KEY_ID" >> $CREDENTIAL_FILE
echo "aws_secret_access_key=$RAW_S3_AWS_SECRET_ACCESS_KEY" >> $CREDENTIAL_FILE
